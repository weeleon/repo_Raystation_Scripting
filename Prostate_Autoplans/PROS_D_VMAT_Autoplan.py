...
ScriptedRois = [external, femHeadLeft, femHeadRight, hvRect, marker1, marker2, marker3, marker4, marker5, marker6,ptvT, ptvSV, ptvSVE, ptvE,transitionTtoSVE, ptvTSVE, wall8mmPtvT, wall5mmPtvE, complementExt5mmPtvE]
...
CreateUnionPtvSVE(pm,examination)
CreateUnionPtvTSVE(pm,examination)
CreateTransitionPtvTPtvSVE(pm,examination)
#
